...
def subgraph_extraction_labeling(ind, Arow, Acol, h=1, sample_ratio=1.0, max_nodes_per_hop=None, 
    ...
    return temp_u_nodes, temp_v_nodes, temp_y, u, v, r, node_labels, max_node_label, y, node_features




def construct_pyg_graph(temp_u_nodes, temp_v_nodes, temp_y, u, v, r, node_labels, max_node_label, y, node_features):
    ...
    data = Data(temp_u_nodes, temp_v_nodes, temp_y, x, edge_index, edge_type=edge_type, y=y)
