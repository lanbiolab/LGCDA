...
def auc_calculate(model, loader, device, show_progress=False):
    ...
    trainfile_path = 'D:\\mydataset\\dataset2\\fold_file\\circRNA-disease-fold5\\train.txt'
    testfile_path = 'D:\\mydataset\\dataset2\\fold_file\\circRNA-disease-fold5\\test.txt'
    ####case_study####
    # trainfile_path = 'D:\\mydataset\\dataset2\\case_study\\train.txt'
    # testfile_path = 'D:\\mydataset\\dataset2\\case_study\\test.txt'
    ####case_study####
    ...
    ####存储casestudy###
    # fileName1 = "./CaseStudy/CaseStudyresult.txt"
    ...
    # 用h5py数据形式将它存储下来
    # with h5py.File('./plotfigure_denovo/dataset2_lambda0_K/dataset2_lambda0_K3_2/dataset2_lambda0_K3_2_fold5.h5', 'w') as hf:
    #     hf['tpr_arr'] = tpr_arr
    #     hf['fpr_arr'] = fpr_arr
