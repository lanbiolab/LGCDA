...
# Dataset
We performed 5-fold cross validation on four datasets. Dataset1 is obtained from the CircR2Disease database. Dataset2 is collected from the CircR2Cancer database. Dataset3 is obtained from the CircRNADisease database. Dataset4 is downloaded from the Circad database. We divided the known circRNA-disease associations into five equal parts and stored them in .txt files.
...
# Questions
+ If you have any questions or find the problems in this paper or code, please contact with me: Chunling Li: li_chunling@st.gxu.edu.cn
