...
def mydataset_create_trainvaltest_split(dataset, seed=1234, testing=False, datasplit_path=None,
    ...
    train_exist_users = []
    train_exist_items = []
    trainfile_path = 'D:\\mydataset\\dataset2\\fold_file\\circRNA-disease-fold5\\train.txt' #某一数据集的某一折训练数据路径
    ...
    circRNA_similarity, disease_similarity = similarity(num_users, num_items, trainfile_path)  #相似度计算
